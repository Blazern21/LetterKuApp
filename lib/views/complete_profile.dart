...
import 'package:depan/views/genre_select.dart';
import 'package:depan/styles/button.dart';
import 'package:depan/views/account_edit.dart';
                          ...
                          Column (
                            children: [
                              ElevatedButton(
                                style: buttonPrimary,
                                onPressed: () => Navigator.of(context).push(
                                    MaterialPageRoute(builder: (_) => AccountEdit() )), //ini nanti ke main menu
